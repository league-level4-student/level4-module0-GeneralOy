...
public class WorldPanel extends JPanel implements MouseListener, ActionListener {
	...
	public void randomizeCells() {
		...
		/**
		 * 4. Iterate through each cell and randomly set each // cell's isAlive memeber
		 * to true of false
		 */
	...
	/**
	 * 9. Complete the method. // It returns an array list of the 8 or less
	 * neighbors of the // cell identified by x and y
	 */
